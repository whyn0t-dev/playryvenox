        ...
        <div className="container mx-auto px-4 py-6">
            ...
            <div className="mb-6 flex flex-wrap gap-2">
                <button
                    ...
                    className={`rounded border px-4 py-2 ${selectedBuilding === "generator" ? "bg-primary text-white" : ""
                        }`}
                >
                ...
                <button
                    ...
                    disabled={loadingAction}
                    className={`rounded border px-4 py-2 ${selectedBuilding === "storage" ? "bg-primary text-white" : ""
                        }`}
                >
                ...
                <button
                    ...
                    disabled={loadingAction}
                    className={`rounded border px-4 py-2 ${selectedBuilding === "wall" ? "bg-primary text-white" : ""
                        }`}
                >
